                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href={`/account/pass-recovery`} className="font-medium text-indigo-600 hover:text-indigo-500">
                        ...
                        <div className=' items-center'>
                            ...
                            <p className="mt-3 text-center text-sm text-gray-600">
                                <a href={`/account/register`} className="font-medium text-indigo-600 text-decoration: underline hover:text-indigo-500">
                                    Create account
                                </a>
                            </p>
                        </div>
